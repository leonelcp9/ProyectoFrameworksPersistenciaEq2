...
public class ProductoDaoImplTest {
	...
	public void pruebaAltaProducto() {
		...
		try {
			System.out.println("Producto dado de alta con �xito");
			producto.setCantidad(100);
			producto.setIdProducto(4);
			producto.setIdMarca(2);
			producto.setNombre("Sprite");
	...
	public void pruebaActualizarProducto() {
		...
		try{
			producto.setCantidad(130);
			producto.setIdProducto(1);
			producto.setIdMarca(2);
			producto.setNombre("Rey");
			producto.setPrecio(25);
			producto.setPrecioVta(27);
	...
	public void pruebaConsultaPorId(){
		...
		try{
			...
			System.out.println("Marca ID: " + producto.getIdMarca());
